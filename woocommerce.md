| Personal Datum                             | Where Stored                                      | Key                     |
|--------------------------------------------|---------------------------------------------------|-------------------------|
...
| Payment Token User ID                      | (wp_)woocommerce_payment_tokens                   | user_id                 |
| Downloadable Product User ID               | (wp_)woocommerce_downloadable_product_permissions | user_id                 |
| Downloadable Product User Email            | (wp_)woocommerce_downloadable_product_permissions | user_email              |
| API Key User ID                            | (wp_)woocommerce_api_keys                         | user_id                 |
| Download Log Entry User ID                 | (wp_)wc_download_log                              | user_id                 |
| Download Log Entry User IP Address         | (wp_)wc_download_log                              | user_ip_address         |
